...
Admini comes with comprehensive documentation and step-by-step guides:
...
- 🎨 **[Custom CSS Guide](guides/CUSTOM_CSS_GUIDE.md)** - Create custom themes for Admini 2.5.5-dev
...
Admini supports a wide range of PHP versions across different operating systems:
...
Admini runs on x86_64 architecture and supports the following operating systems:
...
Install Admini easily with the following command:
...
- 🤝 [Contributing Guide](CONTRIBUTING.md) - How to contribute to Admini development
...
- 🤖 [AI Scanner Setup](guides/AIScannerDocs.md) - Configure AI-powered security scanning
- 📧 [Mautic Installation](guides/MAUTIC_INSTALLATION_GUIDE.md) - Email marketing platform setup
- 🎨 [Custom CSS Guide](guides/CUSTOM_CSS_GUIDE.md) - Create custom themes for Admini 2.5.5+
- 🛡️ [Firewall Blocking Feature](guides/FIREWALL_BLOCKING_FEATURE.md) - One-click IP blocking from dashboard
